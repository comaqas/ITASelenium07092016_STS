...
public class Locators {
    private static final Properties locators; /*чтоб работать с файлом проперти*/
    static{/*статические инициализатор*/
        locators = new Properties();
        InputStream inputStreamFile = Locators.class.getResourceAsStream("/locators.properties");
        try{
    ...
    private enum LocatorType{
        id, name, css, xpath, tag, text, partText/*возможные типы локаторов*/
    }
